...
- 收件人資訊方框
- 表格顯示商品（SKU、數量、未折扣單價、未折扣小計）
- 數量、單價、小計（右對齊）
- 間行換色（Zebra striping）
- Subtotal / Discount / Packing Slip Total 金額顯示
...
- Subtotal 顯示折扣前原始小計
- Discount 顯示折扣金額
- Packing Slip Total 顯示顧客實付金額
- 使用 WooCommerce 原生的 `woocommerce_order_actions_start` hook
